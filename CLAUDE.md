...
- Platform interactions — auth, the credential helper, pull/push, publish, account-free local Fork and maintained updates, and recipient-shaped Share — shell the bundled `ideaspaces` CLI. Fork/update and Share stay skill-mediated flows rather than automatic native-tool mirrors.
